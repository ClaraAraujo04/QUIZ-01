const questions = [
    ...
    {
      question: "(UEM – Vestibular 2010 – Inverno - Adaptado) A Filosofia de Friedrich Nietzsche (1844-1900) é marcada por uma nova relação entre o racional e o irracional, na medida em que o irracional adquire validade por corresponder à necessidade de um movimento de afirmação da vida. Analise as afirmativas abaixo e marque a alternativa que apresenta as afirmações corretas: I – Para Nietzsche, o Iluminismo não libertou os homens de seus prejuízos, mas reforçou ainda mais seus mitos, como a crença na razão e no conhecimento científico. II – O recurso metodológico proposto por Nietzsche é a genealogia, isto é, movimento teórico que recorre à gênese de um discurso, conceito ou prática, apontando suas arbitrariedades e interesses; III – Para Nietzsche, o conhecimento é fruto de um lento processo de acumulação e comprovação empírica, cuja finalidade é salvar os fenômenos; IV – Contra a moral dos aristocratas e nobres, Nietzsche defende os fracos, isto é, a moral dos escravos; V – A “vontade de potência” é a afirmação do nacional-socialismo alemão, expresso na doutrina do super-homem e no antissemitismo nietzscheano",
      options: [
    ...
    {
      question: "8- (PUCPR – 2010) Na sua obra Novum Organum, publicado em 1620, o filósofo Francis Bacon inaugura uma nova concepção de conhecimento científico. Sobre esse novo conceito de ciência, é CORRETO afirmar que:  I. Para Bacon, a nova ciência deveria continuar usando o método dedutivo, já que ele é superior ao método indutivo, pois este estaria por demais limitado aos dados estatísticos observáveis. II. Ele pretende distanciar-se da visão aristotélica de ciência como pura contemplação, como um saber em si mesmo. III. Ele busca um tipo de ciência que não privilegie o falar (a retórica), mas o fazer (as obras), ou seja, trata-se de um método de enfrentamento da natureza visando a transformar o mundo a favor do ser humano. É isso o que explica a sua frase: “Os gregos, com efeito, possuem o que é próprio das crianças: estão sempre prontos para tagarelar, mas são incapazes de gerar, pois a sua sabedoria é farta em palavras, mas estéril em obras”. (Novum Organum, Livro I, § LXXI). IV. Para Bacon, o saber científico dos gregos (entre os quais Aristóteles) é extremamente útil para a ciência moderna porque forneceria as bases para a pesquisa instrumental.",
      options: [
    ...
    {
      question: "9- (Universidade Federal de São João Del-Rei - UFSJ - Vestibular 2012/1) Sobre os ídolos preconizados por Francis Bacon, é CORRETO afirmar que:",
      options: [
    ...
    {
      question: "10- (CONSULPLAN) “Em si mesmo, o homem não é bom nem mau, mas, de fato, tende a ser mau. Consequentemente, o político não deve confiar no aspecto positivo do homem, mas, sim, constatar o seu aspecto negativo e agir em consequência disso. Assim, não hesitará em ser temido e a tomar as medidas necessárias para tornar-se temível. Claro, o ideal seria o de ser ao mesmo tempo amado e temido. Mas essas duas coisas são muito difíceis de ser conciliadas e, assim, deve fazer a escolha mais funcional para o governo eficaz do Estado.” Considerando a filosofia renascentista, o pensamento descrito anteriormente deve-se a:",
      options: [
        "A) Nicolau Maquiavel",
        "B) Erasmo de Roterdã",
